package com.comerlato.school_project.exception.handler;
...
import static com.comerlato.school_project.exception.ErrorCodeEnum.ERROR_DUPLICATED_FIELD;
import static com.comerlato.school_project.exception.ErrorCodeEnum.ERROR_GENERIC_EXCEPTION;
...
public class ResourceExceptionHandler {
    ...
    public ResponseEntity<ErrorDTO> handleDataIntegrityException(DataIntegrityViolationException e, HttpServletRequest request) {
        ...
        String errorMessage;
        if (requireNonNull(requireNonNull(ex.getServerErrorMessage()).getConstraint()).equalsIgnoreCase("add")) {
    ...
    public ResponseEntity<StandardError> handleConstraintViolationExceptions(ConstraintViolationException e, HttpServletRequest request) {
    ...
    public ResponseEntity<StandardError> handlerParseException(ParseException e, HttpServletRequest request) {
        HttpStatus status = BAD_REQUEST;
        log.error(request.getRequestURI(), e);
        return ResponseEntity
                .status(status)
